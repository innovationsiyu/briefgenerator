...
- 请严格基于source_text，按照序号依次检查每一个fact_sentence中有没有与前面的fact_sentences重复的信息，有没有不属于source_text中的新闻文章的事实或观点，根据检查结果确定每一个fact_sentence是否需要修改或删除，最后给出一个true or false的判断，构成JSON格式的feedback_on_fact_sentences，包裹在XML标签<feedback_on_fact_sentences>中输出。
...
- 关于"corrections_required"的布尔值，如果全部n句的检查结果都是“没有重复信息”和“没有曲解原意”，输出false，否则输出true。
