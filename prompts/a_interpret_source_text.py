...
- 你收到的source_text包括一篇或多篇新闻文章，可能还包括其他分析师的观点或分析要求，这些都包裹在XML标签<source_text>中。
...
13. 除了新闻文章，source_text中有没有其他分析师提到的分析视角与分析方向？如果有，请提取出来，可以调整表达使其更易于理解；如果没有，请你独立思考对这个中心新闻事件可以从哪些视角在哪些方向上展开分析，总结为一两句话即可。
14. 除了新闻文章，source_text中有没有其他分析师提出的观点或分析要求？如果有，请提取出来，可以调整表达使其更易于理解；如果没有，输出空字符串""。
