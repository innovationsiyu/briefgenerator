...
- 请严格基于source_text，对fact_paragraph依次执行行动清单中的10个步骤，最后一个步骤是给出true or false的判断，将全部检查结果和判断包裹在XML标签<feedback_on_fact_paragraph>中输出。
...
9. fact_paragraph必须直接呈现具体事实信息，避免“据统计”“数据显示”等实际未提示来源的来源提示词。指出应删除的实际未提示来源的来源提示词，或者输出“完全符合要求”。
10. 根据目前的检查结果，判断是否需要修改fact_paragraph。如果9项检查结果都是“完全一致”或“完全正确”或“完全符合要求”，输出“"corrections_required": false”，否则输出“"corrections_required": true”。

## 请注意
- 请严格基于source_text，对fact_paragraph依次执行行动清单中的9项检查，最后给出判定。可以重复每一项检查的要求，使思考过程呈现更清晰。
