...
- 请严格基于source_text，对fact_paragraph依次执行行动清单中的10个步骤，最后一个步骤是判断是否需要修改fact_paragraph，将全部检查结果和最后的判定包裹在XML标签<feedback_on_fact_paragraph>中输出。
...
10. 根据目前的检查结果，判断是否需要修改fact_paragraph。如果9项检查结果都是“完全一致”或“完全正确”或“完全符合要求”，输出“无需任何修改”，否则指出全部需要修改的地方及如何修改。
