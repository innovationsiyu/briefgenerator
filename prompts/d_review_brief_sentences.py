...
- 注意避免遗漏任何细节信息。例如，如果文章原文提到“美国7月CPI同比增速回落至2.8%，核心CPI同比涨幅降至3.1%”，那么正确的写法是“美国7月CPI同比增速回落至2.8%，核心CPI同比增速回落至3.1%”，其中的数据变动方向等全部信息都必须保留；典型的错误写法是“美国7月CPI同比2.8%、核心CPI同比3.1%”，因为数据变动方向被遗漏了。
- 为了避免遗漏任何细节信息，最好的方法是尽力避免对相应的原文做简化，保持原文的详细程度。
